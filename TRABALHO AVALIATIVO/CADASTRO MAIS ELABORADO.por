programa
{
	...
	funcao inicio()
	{
		...
		escreva("-----------------------------------------|\n\n")
          ...
          escreva(" 4-Excluir cliente cadastrado\n")
     ...
     funcao remover()
     {
		...
		para(n = 0 ; n < ponteiro ; n++)
		{
			se(nome[n] == busca) // comparação: se nome é igual a busca
			{
				...
				senao
				{
					escreva("O usuario ", nome[n], " foi mantido no vetor!\n")
				}
			}
		}
		 ...
		 {
              limpa()
              escreva("\n\nATENÇÃO: Nenhum cliente encontrado com esse nome!", busca, "!\n")
		 }
